...
<html lang='en'>
  ...
  <div id='__react-email-preview' style='display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0'>
    The civil engineering expertise that builds the future.
  </div>
  <body style='background-color:#ffffff;font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,Oxygen-Sans,Ubuntu,Cantarell,&quot;Helvetica Neue&quot;,sans-serif'>
    <table align='center' role='presentation' cellSpacing='0' cellPadding='0' border='0' width='100%' style='max-width:37.5em;margin:0 auto;padding:20px 0 48px'>
      <tr style='width:100%'>
        <td>
          <img alt='yslcivils' src='https://drive.google.com/uc?export=view&id=1FajbLfibTdqLh3goBqMRcm7xQguPne4T' width='100' height='100' style='display:block;outline:none;border:none;text-decoration:none;margin:0 auto' />
          <p style='font-size:16px;line-height:26px;margin:16px 0'>Hi ${fullname},</p>
          <p style='font-size:16px;line-height:26px;margin:16px 0'>
            Thank you for reaching out to yslcivils! We have received your inquiry through our Contact Us form.
          ...
          <p style='font-size:16px;line-height:26px;margin:16px 0'>Best,<br />The yslcivils Team</p>
